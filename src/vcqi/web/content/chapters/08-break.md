<!-- 08-break.md -- chapter 7 in the rail; the NN- prefix is the position in the
     ...
     The twenty-four cases themselves -- their titles, what each one does and the check it
...
Twenty-four ways this can go wrong, and the check that catches each. The interesting ones pass every cryptographic test.

<!-- 09-tamper.md -- chapter 8 in the rail; the NN- prefix is the position in the
     ...
     twenty-four cases that reach further than one document can, because they change the
...
The last chapter applied twenty-four failures somebody else chose. This is the same pipeline with the document in your hands: pick a certificate, change one of the fields it states, and run it.

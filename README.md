...
published entry — which the KCDB serves unsigned, so it is the one register here a
verifier must go and fetch for itself. The bound runs in the direction people new to it
get backwards:
